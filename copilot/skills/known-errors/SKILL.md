...
- Use only generation tools visible on the current host. Codex, Claude Code,
  and GitHub Copilot CLI plugins direct-author Motion Graphics with
  `create_motion_graphic_from_code`; the built-in ChatCut Agent may expose
