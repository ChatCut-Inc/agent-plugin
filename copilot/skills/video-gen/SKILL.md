...
External URLs and base64 are not accepted. If the source is a public URL,
download it into the workspace, import the local file through `asset-import`
and `import_media`, and pass the resulting asset id.
