...
**Revising a `kling` 1080p clip has no lossless path.** `omni` returns at up to 720p; `seedance-2-5` and `seedance2` can output 1080p but still re-infer from scratch. Tell the user what each path loses and let them choose before submitting.
