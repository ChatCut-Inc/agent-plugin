...
External URLs and base64 are not accepted. If the host can download the source locally, follow `chatcut-media-guide` to import it and pass the resulting asset id; otherwise ask the user to upload it in the visible ChatCut editor.
